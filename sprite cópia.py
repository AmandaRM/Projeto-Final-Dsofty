# -*- coding: utf-8 -*-
"""
Created on Tue May 22 16:44:35 2018
...
import plataform
import movimento_copia as movimento
...
#  tela.blit(text, (720,20)) 
  ...
  for event in pygame.event.get():  #pega lista de eventos 0)
    ...
    if event.type == pygame.KEYDOWN:
        if event.key == K_UP:
             bonzinho=movimento.bonequinho.jump(bonzinho)
...
#      gameover()
  ...
  if pressed_keys[K_LEFT]:
      bonzinho=movimento.bonequinho.check_keys(bonzinho)
...
#      malvado=movimento.bonequinho.bom_RIGHT(malvado)  
  ...
  if bonzinho.rect.x > malvado.rect.x:
     malvado=movimento.bonequinho.check_keys_light(malvado)
  ...
  if bonzinho.rect.y < malvado.rect.y:
      malvado=movimento.bonequinho.jump_light(malvado)
